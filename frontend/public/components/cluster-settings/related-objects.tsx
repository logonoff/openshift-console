...
const ResourceObjectName: React.FC<React.PropsWithChildren<ResourceObjectNameProps>> = ({
  gsv,
  name,
  namespace,
}) => {
...
const Row: React.FC<React.PropsWithChildren<RowFunctionArgs>> = ({
  obj,
...
const RelatedObjects: React.FC<React.PropsWithChildren<RelatedObjectsProps>> = (props) => {
...
const RelatedObjectsPage: React.FC<React.PropsWithChildren<RelatedObjectsPageProps>> = (props) => {
