...
export const ManagedByOperatorResourceLink: React.FC<React.PropsWithChildren<ManagerLinkProps>> = ({
  csvName,
  namespace,
  owner,
  className,
...
export const ManagedByOperatorLink: React.FC<React.PropsWithChildren<ManagedByLinkProps>> = ({
  obj,
  className,
}) => {
