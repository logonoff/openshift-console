...
export const ResourceIcon: React.FC<React.PropsWithChildren<ResourceIconProps>> = ({
  className,
  groupVersionKind,
  kind,
}) => {
...
export const ResourceName: React.FC<React.PropsWithChildren<ResourceNameProps>> = (props) => (
