...
The `console.dashboards/overview/detail/item` extension has been removed. This
extension was deprecated in favor of the `console.dashboards/custom/overview/detail/item` extension.
