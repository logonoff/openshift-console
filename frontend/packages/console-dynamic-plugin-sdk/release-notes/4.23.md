...
PatternFly CSS upgrades from 6.4.x to 6.5.x, introducing two new themes: **High contrast** and **Glass**. These themes work without modification. If your plugin includes custom CSS that overrides PatternFly styles, test your plugin with the new themes to verify that styles render correctly.
