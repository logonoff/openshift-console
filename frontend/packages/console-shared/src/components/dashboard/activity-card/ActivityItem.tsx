...
export const ActivityProgress: React.FC<React.PropsWithChildren<ActivityProgressProps>> = ({
  title,
  progress,
  children,
}) => (
...
const ActivityItem: React.FC<React.PropsWithChildren<ActivityItemProps>> = ({
  children,
  className,
}) => (
  <>
