...
type CreateConnectorRenderer = React.ComponentType<
  React.PropsWithChildren<ConnectorComponentProps>
>;
...
const CreateConnectorWidget: React.FunctionComponent<React.PropsWithChildren<
