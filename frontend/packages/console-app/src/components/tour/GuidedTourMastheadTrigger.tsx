...
const GuidedTourMastheadTrigger: React.FC<React.PropsWithChildren<
  GuidedTourMastheadTriggerProps
>> = React.forwardRef(({ className }, ref: React.LegacyRef<HTMLButtonElement>) => {
