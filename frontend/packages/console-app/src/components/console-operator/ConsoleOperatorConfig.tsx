    ...
    () =>
      pluginInfo
        ...
        .map((plugin) => ({
          ...
          description: (plugin.manifest?.customProperties?.console as any)?.description,
    ...
    return consolePlugins.map((plugin) => {
      ...
      if (loadedPluginInfo) {
        return {
          ...
          description: (loadedPluginInfo?.manifest?.customProperties?.console as any)?.description,
          enabled,
